;;; godot-default-theme.el --- Theme

;; Copyright (C) 2025 , SalORak
...
;;; Commentary:
;;; godot-default theme created by SalORak in 2025

;;; Code:

(deftheme godot-default)
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(region ((,class (:background ,selection :foreground ,fg1))))
   `(highlight ((,class (:foreground ,fg3 :background ,bg3))))
	 `(hl-line ((,class (:background  ,bg2))))
	 `(fringe ((,class (:background ,bg2 :foreground ,fg4))))
	 `(cursor ((,class (:background ,fg4))))
   `(isearch ((,class (:bold t :foreground ,warning :background ,bg3))))
   `(mode-line ((,class (:box (:line-width 1 :color ,fg1) :bold t :foreground ,fg4 :background ,bg2))))
   ...
   `(solaire-default-face ((,class (:background ,bg2))))
   `(solaire-fringe-face ((,class (:foreground ,keyword :background ,bg3))))
   `(solaire-hl-line-face ((,class (:background ,bg4)))))
   ;; Legacy
...
(provide-theme 'godot-default)
;; Local Variables:
;; no-byte-compile: t
;; End:

;;; godot-default-theme.el ends here
